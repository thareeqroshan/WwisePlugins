...
#ifndef FMALGainFXParams_H
#define FMALGainFXParams_H
...
struct FMALGainRTPCParams
{
    AkReal32 fDummy;
};

struct FMALGainNonRTPCParams
{
};

struct FMALGainFXParams
    : public AK::IAkPluginParam
{
    FMALGainFXParams();
    FMALGainFXParams(const FMALGainFXParams& in_rParams);
    ...
    FMALGainRTPCParams RTPC;
    FMALGainNonRTPCParams NonRTPC;
} AK_ALIGN_DMA;

#endif // FMALGainFXParams_H
